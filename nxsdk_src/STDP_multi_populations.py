...
def setupNetwork(net, 
    ...
    connProtoIn = nx.ConnectionPrototype(weight=22, delay=5)
    connProtoIn2 = nx.ConnectionPrototype(weight=11, delay=5)
    connProtoReset = nx.ConnectionPrototype(weight=60, delay=5)
    connProtoNoise = nx.ConnectionPrototype(weight=30, delay=5) 
    ...
    synaptic_connectivity6 = 0.257 + 0.001 #0.001 to compensate for the bits that are to be flipped in loops
