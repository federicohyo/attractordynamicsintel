...
def setupNetwork(net, numECores, numICores, numSpikeGen, tau, E1pc, Enoise, Inoise):
    ...
    synaptic_connectivity4 = 0.525#10
    synaptic_matrix4 = np.random.rand(numICores, numICores) < synaptic_connectivity4
    cg2.connect(cg2, prototype=connProto2, connectionMask=synaptic_matrix4) #connProto1!
    
    # Connect the inhibitory population to the excitatory population
    synaptic_connectivity5 = 0.192
    ...
    return SpikesProbe, VoltageProbe, SpikesProbeIn, VoltageProbeIn
...
def main(): 
    ...
    for trial in range(1):
        ...
        (cg1Spikes, cg1_0Voltage, cg1SpikesIn, cg1_0VoltageIn) = setupNetwork(net, numECores, numICores, numSpikeGen, tau, Epc1, Enoise, Inoise)
        ...
        plt.ylabel("stim", fontsize = 20)

        ax1 = plt.subplot(5, 1, 2)
        sp_in = cg1Spikes[0].plot()
        #plt.title('postsynaptic spikes (Exc)', fontsize = 20)
        plt.xticks(fontsize=20)
        plt.yticks(fontsize=20)
        plt.xlabel("", fontsize = 20)
        plt.ylabel("Exc", fontsize = 20)
        ...
        sp_in = cg1SpikesIn[0].plot()
        #plt.title('postsynaptic spikes (Inh)', fontsize = 20)
        plt.xticks(fontsize=20)
        plt.yticks(fontsize=20)
        plt.xlabel("", fontsize = 20)
        plt.ylabel("Inh", fontsize = 20)
        ...
        np.save("data/fed/self_sustained_ok/spiketimes_inp_self_sustained"+filename1+".npy", spikeTimes)
        ...
        np.save("data/fed/self_sustained_ok/cg1Spikes_self_sustained"+filename1+".npy", cg1Spikes[0].data)
        np.save("data/fed/self_sustained_ok/cg1SpikesIn_self_sustained"+filename1+".npy", cg1SpikesIn[0].data)
        ...
        np.save("data/fed/self_sustained_ok/cg1_0Voltage_self_sustained"+filename1+".npy", cg1_0Voltage[0].data)
        np.save("data/fed/self_sustained_ok/cg1_0VoltageIn_self_sustained"+filename1+".npy", cg1_0VoltageIn[0].data)
        np.save("data/fed/self_sustained_ok/meanFreqOutArray_self_sustained"+filename1+".npy", meanFreqOutArray[0])
